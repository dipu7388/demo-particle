...
cells
 ...
 rotateCarousel() {
  ...
  this.apphabetsContainer.style.transform = 'translateZ(' + - this.radius + 'px) ' +
...
particles (canvas) {
    ...
    W = canvas.getBoundingClientRect().width * .9;
    H = canvas.getBoundingClientRect().height * .9;
    ...
    function Particle() {
        ...
        this.vx = (2 * Math.random() + 1)*.1;
        this.vy = (2 * Math.random() + 1)*.1;
